// data/practica-libre/rules.js
// Port de las reglas del repo UlisesAriasS/Ecuaciones-quiziz (js/app.js).
// Cada regla detecta (vía regex) qué método/fórmula aplicar a una expresión LaTeX.
...
export const rules = [
  // ============ 1. DERIVADAS ============
  {
    ...
    match: (latex) =>
      (latex.includes('\\frac{d}{dx}') || latex.includes('\'(')) &&
