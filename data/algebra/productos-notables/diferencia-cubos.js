// data/algebra/productos-notables/diferencia-cubos.js
// Ley: Diferencia de cubos  ->  a³ - b³ = (a - b)(a² + ab + b²)

export default {
  lawId: 'diferencia-cubos',
  lawName: 'Diferencia de cubos',
  lawFormula: 'a^3 - b^3 = (a - b)(a^2 + ab + b^2)',
  prerequisites: 'Conocer la suma de cubos.',
  available: true,
  questions: [
    // ---------- Fáciles (5) ----------
    {
      ...
      explanation:
        '$x^3 - 1 = (x-1)(x^2 + x + 1)$. El signo del término central es positivo.'
    },
    {
      id: 'difcub-f-02',
      difficulty: 'easy',
    ...
    // ---------- Medias (5) ----------
    {
      ...
      options: [
        ...
        { latex: '(2x - 1)(4x^2 + 4x + 1)', correct: false }
      ],
      explanation:
    ...
    // ---------- Difíciles (5) ----------
    {
      id: 'difcub-h-01',
      difficulty: 'hard',
      prompt: 'Simplifica: $\\frac{x^3 - 1}{x - 1}$',
      options: [
        { latex: 'x^2 + x + 1', correct: true },
        { latex: 'x^2 - x + 1', correct: false },
        { latex: 'x + 1', correct: false },
        { latex: 'x^2 + 2x + 1', correct: false }
      ],
      explanation:
        '$x^3 - 1 = (x-1)(x^2 + x + 1)$. Al dividir entre $x-1$ queda $x^2 + x + 1$.'
    },
    {
      id: 'difcub-h-02',
      difficulty: 'hard',
      prompt: 'Si $x^3 - 8 = (x - 2)(x^2 + ax + 4)$, ¿cuál es el valor de $a$?',
      options: [
      ...
      explanation:
        'En $x^3 - b^3 = (x-b)(x^2 + bx + b^2)$ con $b=2$, el término central es $bx = 2x$, por lo que $a = 2$.'
    },
    {
      id: 'difcub-h-03',
      difficulty: 'hard',
    ...
    },
    {
      id: 'difcub-h-05',
      difficulty: 'hard',
      prompt: 'Factoriza: $x^3 - 125$',
      options: [
        { latex: '(x - 5)(x^2 + 5x + 25)', correct: true },
        { latex: '(x - 5)^3', correct: false },
        { latex: '(x - 5)(x^2 - 5x + 25)', correct: false },
        { latex: '(x - 5)(x^2 + 10x + 25)', correct: false }
      ],
      explanation:
